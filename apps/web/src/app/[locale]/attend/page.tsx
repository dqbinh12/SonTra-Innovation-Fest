    ...
    <>
      ...
      <section className="bg-brand-navy relative isolate overflow-hidden pt-24 pb-10 text-white sm:pt-28 sm:pb-14">
        ...
        <Container className="relative">
          ...
          {page?.heroBody && (
            <p className="mt-3 max-w-xl text-xs sm:text-sm text-white/80 leading-relaxed">{page.heroBody}</p>
          )}
      ...
      <section className="relative scroll-mt-24 py-10 sm:py-14" id="audience">
        ...
        <Container>
          <ScrollReveal>
            ...
            <p className="text-muted-foreground mt-2 max-w-2xl text-xs sm:text-sm leading-relaxed">{t('audienceLead')}</p>
          </ScrollReveal>
        ...
        <Container>
          <ScrollReveal>
            <div className="bg-brand-navy relative isolate overflow-hidden rounded-2xl px-5 py-10 text-center text-white sm:rounded-3xl sm:px-10 sm:py-12">
              ...
              <p className="mx-auto mt-4 max-w-xl text-xs sm:text-sm text-white/85 leading-relaxed">{t('ctaBody')}</p>
